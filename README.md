...
- Sau khi đăng nhập, tài khoản VIP/Admin có giao diện lung linh huyền ảo riêng và nút bật/tắt nhạc nền dịu nhẹ.
...
Trình duyệt có thể chặn tự phát âm thanh. Với tài khoản VIP/Admin, sau khi đăng nhập hãy bấm nút **♪ Bật nhạc nền** ở góc dưới bên phải. Bản này đã tăng âm lượng nhẹ và sửa nút để phát ổn định hơn sau khi người dùng bấm.
